...
The `name` property refers to the label name and the `color` property should be set to the color of the label as a hex code, both with or without the leading `#` are valid.
